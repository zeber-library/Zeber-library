...
const songs = [
  {
    songName: "The Silent Patient",
    filePath: "/songs/10.mp3",
    coverPath: "/AudioBookPlayer/images/shopping.webp",
    author: "Author 1",
    genre: "Genre 1",
  },
  {
    songName: "Robinson Crusoe",
    filePath: "/songs/3.mp3",
    coverPath:
      "/AudioBookPlayer/images/best-novels-of-all-time-3-62c2f5a1643f1__700.jpg",
    author: "Author 2",
    genre: "Genre 2",
  },
  {
    songName: "Harry Potter",
    filePath: "/songs/6.mp3",
    coverPath:
      "/AudioBookPlayer/images/Harry-Potter-and-the-Chamber-of-Secrets-book-cover.webp",
    author: "Author 3",
    genre: "Genre 3",
  },
  {
    songName: "All the Night We Cannot See",
    filePath: "/songs/3.mp3",
    coverPath: "/AudioBookPlayer/images/product-jpeg-500x500.webp",
    author: "Author 4",
    genre: "Genre 4",
  },
  {
    ...
    coverPath: "/AudioBookPlayer/images/images.jpg",
    author: "Author 5",
    genre: "Genre 5",
  },
  {
    ...
    coverPath:
      "/AudioBookPlayer/images/canva-brown-rusty-mystery-novel-book-cover-hG1QhA7BiBU.jpg",
    author: "Author 6",
    genre: "Genre 6",
  },
];
    ...
    const updateProgress = () => {
      ...
      if (audioElement.current.duration) {
        ...
        const currentMinutes = Math.floor(
          audioElement.current.currentTime / 60
        );
        const currentSeconds = Math.floor(audioElement.current.currentTime % 60)
          .toString()
          .padStart(2, "0");
        ...
        const durationSeconds = Math.floor(audioElement.current.duration % 60)
          .toString()
          .padStart(2, "0");
